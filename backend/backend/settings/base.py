...
SECRET_KEY = "django-insecure-k(ysy=4gy@a3$s12l4@8c-ugf*x*mke643t#fj)$@a-f2_gab1"
...
AUTH_USER_MODEL = "firebase.AppUser"
...
REST_AUTH_SERIALIZERS = {
    'USER_DETAILS_SERIALIZER': 'firebase.serializers.AppUserSerializer'
}
