          ...
          <div className="w-full px-4 lg:w-1/4 md:w-1/2">
            ...
            <div className="flex flex-wrap items-end justify-center xl:flex-nowrap md:flex-nowrap lg:flex-wrap md:justify-start">
              <div className="relative w-40 mr-2 sm:w-auto xl:mr-4 lg:mr-0 sm:mr-4">
                <label htmlFor="footer-field" className="text-sm text-gray-400 leading-7">
                  Placeholder
                </label>
                <input
                  type="text"
                  id="footer-field"
                  name="footer-field"
                  className="w-full px-3 py-1 text-base text-gray-100 bg-gray-800 border border-gray-700 rounded outline-none bg-opacity-40 focus:bg-transparent focus:ring-2 focus:ring-indigo-900 focus:border-indigo-500 leading-8 transition-colors duration-200 ease-in-out"
                />
              </div>
      ...
      <div className="bg-gray-800 bg-opacity-75">
        <div className="container flex flex-col items-center px-5 py-6 mx-auto sm:flex-row">
          <a className="flex items-center justify-center font-medium text-white title-font md:justify-start">
            ...
            <span className="ml-3 text-xl">FOLDABLE</span>
          </a>
