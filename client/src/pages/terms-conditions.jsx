function Home() {
  return (
    <div className="h-[100vh] flex flex-col justify-center align-middle text-center">
      ...
      <p>
        These terms and conditions outline the rules and regulations for the use of Example's
        Website, located at example.com.
      </p>

      <p>
        By accessing this website we assume you accept these terms and conditions. Do not continue
        to use Example if you do not agree to take all of the terms and conditions stated on this
        page.
      </p>
      ...
      <p>
        We employ the use of cookies. By accessing Example, you agreed to use cookies in agreement
        with the Example's Privacy Policy.{' '}
      </p>
      ...
      <p>
        Unless otherwise stated, Example and/or its licensors own the intellectual property rights
        for all material on Example. All intellectual property rights are reserved. You may access
        this from Example for your own personal use subjected to restrictions set in these terms and
        conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from Example</li>
        <li>Sell, rent or sub-license material from Example</li>
        <li>Reproduce, duplicate or copy material from Example</li>
        <li>Redistribute content from Example</li>
      </ul>
      ...
      <p>
        ...
        information in certain areas of the website. Example does not filter, edit, publish or
        review Comments prior to their presence on the website. Comments do not reflect the views
        and opinions of Example,its agents and/or affiliates. Comments reflect the views and
        opinions of the person who post their views and opinions. To the extent permitted by
        applicable laws, Example shall not be liable for the Comments or for any liability, damages
        or expenses caused and/or suffered as a result of any use of and/or posting of and/or
        appearance of the Comments on this website.
      </p>

      <p>
        Example reserves the right to monitor all Comments and to remove any Comments which can be
      ...
      <p>
        You hereby grant Example a non-exclusive license to use, reproduce, edit and authorize
      ...
      <p>
        ...
        visibility of the hyperlink compensates the absence of Example; and (d) the link is in the
      ...
      <p>
        ...
        linking to our website, you must inform us by sending an e-mail to Example. Please include
      ...
      <p>
        No use of Example's logo or other artwork will be allowed for linking absent a trademark
        license agreement.
      </p>
