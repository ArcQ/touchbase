...
const StyledTrigger = tw(NavigationMenuPrimitive.Trigger)`
  ...itemStyles,
  display: 'flex',
  alignItems: 'center',
...
export const NavigationMenuDemo = () => (
  <NavigationMenu className="relative flex justify-center w-screen zIndex: 1">
    <NavigationMenuList className="flex justify-center p-1 list-none bg-white br-3 shadow-sm">
      <NavigationMenuItem>
