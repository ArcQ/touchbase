...
/* eslint-disable */
// forked from https://github.com/osdnk/react-native-reanimated-bottom-sheet
const Screen = {
...
class BottomPanel extends Component {
  ...
  dismissBottomSheet = () => {
    const { snapPoints } = this.props;
    const index = snapPoints.findIndex((x) => x === 0 || x === '0%');
    if (index !== -1) {
  ...
  render() {
    ...
    return (
      <View style={styles.panelContainer} pointerEvents="box-none">
        ...
        <Interactable.View
          dragEnabled={!(isModal || !dragEnabled)}
          verticalOnly
          ref="bottomPanel"
